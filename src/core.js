...
const { iAction, Action, createActionClass, rollD20 } = require('./core/action.js');
const { iWorld, iONOConsole, Encounter } = require('./core/abstractions.js');
const { EncounterPhaseTransitionBuilder, ActionPermissionGraphBuilder } = require('./core/logic_builders.js');
