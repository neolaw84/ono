...
class Entity {
  ...
  constructor({
    ...
    if (!NumAttributesClass || !TxtAttributesClass) {
      throw new Error(
        "Entity constructor requires both 'NumAttributesClass' and 'TxtAttributesClass'.",
      );
    }
...
function createEntityClass({
  ...
  if (!type || !NumAttributesClass || !TxtAttributesClass)
    throw new Error(
      "createEntityClass factory requires 'type', 'NumAttributesClass', and 'TxtAttributesClass'.",
    );
